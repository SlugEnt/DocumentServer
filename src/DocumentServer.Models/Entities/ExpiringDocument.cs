...
#region "Non Fields"
    ...
    /// <param name="expirationDateOnlySetForParentLifetime">
    ///     This is only used when the EnumLifetime value is Parent Type.  If
    ///     not set and type is ParentDetermined then 1 year is used
    /// </param>
