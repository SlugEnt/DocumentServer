...
public enum EnumDocumentStatus
{
    ...
    /// <summary>
    ///     Document has been removed, meaning it is no longer available and is waiting for the archival time period to elapse
    ///     before removing it from the DocumentServer database
    /// </summary>
    Removed = 253
}