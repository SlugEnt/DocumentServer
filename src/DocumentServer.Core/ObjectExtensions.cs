...
{
    /// <summary>
    /// Adds a DeepClone ability to the base C# Object class.  Makes an exact copy of an existing object
    /// </summary>
    public static class ObjectExtensions
    {
        ...
        public static Object Copy(this Object originalObject) { return InternalCopy(originalObject, new Dictionary<Object, Object>(new ReferenceEqualityComparer())); }
                                           ...
                                           IDictionary<Object, Object> visited)
        {
            ...
            if (typeToReflect.IsArray)
            {
                ...
                if (IsPrimitive(arrayType) == false)
                {
                    ...
                    clonedArray.ForEach((array,
                                         indices) => array.SetValue(InternalCopy(clonedArray.GetValue(indices), visited), indices));
                }
            }
            ...
            CopyFields(originalObject,
                       ...
                       cloneObject,
                       typeToReflect);
            RecursiveCopyBaseTypePrivateFields(originalObject,
                                               visited,
                                               cloneObject,
                                               typeToReflect);
            return cloneObject;
